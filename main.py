...
if __name__ == "__main__":
    ...
    db_utils.insert_dataframe(format_data.input_espacios_culturales(df_concat), 'espacios_culturales')
    db_utils.insert_dataframe(format_data.input_registros(df_concat), 'registros')
    db_utils.insert_dataframe(format_data.input_cines(df_dict["df_cines"]), 'cines')
